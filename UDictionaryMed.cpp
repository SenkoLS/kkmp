...
{
	DMAvtoriz->SQLQCatalogMed->Close();
	DMAvtoriz->SQLQCatalogMed->SQL->Text = 	"INSERT INTO `user` (`name`,`surname`,`patronymic`,`login`,`password`) "
											"VALUES('"+ EName->Text +"','"+ EOtch->Text +"','"+ ESurname->Text +"','"+ ELogin->Text +"','"+ EPassword->Text +"')";
