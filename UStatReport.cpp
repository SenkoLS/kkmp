...
void __fastcall TFStatReport::BGenerateReportClick(TObject *Sender)
{
	...
	if(DBGridReport->DataSource == NULL){
		MessageBox(0,L"Вы не сформировали отчет!",L"Сообщение",MB_OK | MB_ICONWARNING);
		return;
	}else{
	...
	vVarCell.OlePropertySet("Value", "Оценка качества ведения медицинской документации и качества оказания медицинской помощи пациентам (I уровень ).");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Эксперт:");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "=СРЗНАЧ(C10:C15)");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "=СРЗНАЧ(C17:C31)");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "=СРЗНАЧ(D10;D17)");
	...
	vVarSheet.OlePropertySet("Name","Ошибки");
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Анализ врачебных ошибок");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Характеристика ошибки");
	vVarCell.OlePropertySet("ColumnWidth", 50);
	...
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Кол-во");
	vVarCell.OlePropertySet("ColumnWidth", 10);
	...
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "На 1 сл.");
	vVarCell.OlePropertySet("ColumnWidth", 10);
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Непосредственные исслед. (информативность, содержательность)");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по информативности жалоб");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по информативности анамнеза болезни");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по физикальным исследованиям");
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по лабораторной диагностике");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Исследование не проведено");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Исследование проведено излишне");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Исследование проведено несвоевременно");
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по инструментальной диагностике");
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по консультациям специалистов");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Консультация не проведена");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Консультация проведена несвоевременно");
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по диагнозу");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "По верификации");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "По времени постановки");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "По содержанию");
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по лечению (фармакотерапии)");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "По выбору препаратов");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "По времени назначения и отмены");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Полипрагмазия");
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Преемственность");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по выбору места дальнейшей помощи");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по времени передачи пациента другому специалисту");
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Замечания по стандарту оказания МП");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",2);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Несоответствие стандартам");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value","=СУММ(C10:C12;C14:C16;C18:C20;C22:C23;C25:C27;C29:C31;C33:C34;C36)");
	...
	vVarSheet.OlePropertySet("Name","Эксперты");
	...
	vVarCell.OlePropertySet("WrapText", true);
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Анализ работы экспертов");
	...
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "ФИО эксперта");
	vVarCell.OlePropertySet("ColumnWidth", 40);
	...
	vVarCell.OlePropertySet("HorizontalAlignment",-4108);
	vVarCell.OlePropertySet("VerticalAlignment",-4108);
	vVarCell.OlePropertySet("Value", "Кол-во провер-ых карт");
